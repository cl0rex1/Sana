...
import { User, Mail, Lock, ArrowRight, ShieldPlus, AlertCircle } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-20 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 -left-20 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-extrabold text-[#1a1a1a] tracking-tight">{t('auth.registerTitle')}</h2>
          <p className="text-gray-500 mt-2">{t('auth.registerSubtitle', 'Join the Sana security community')}</p>
        </div>
        ...
        <Card className="bg-white/80 backdrop-blur-xl border border-white shadow-2xl rounded-[2.5rem] overflow-visible" padding="p-8 md:p-10">
          <GlowEffect color="from-emerald-500/5 to-blue-500/5" className="opacity-50" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  type="text" 
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all text-[#1a1a1a] font-medium"
            ...
            <Button 
              ...
              variant="primary" 
              loading={isLoading}
              className="w-full py-4 rounded-2xl text-lg font-bold shadow-xl shadow-emerald-100 mt-2 bg-emerald-600 hover:bg-emerald-700 border-none"
              icon={ArrowRight}
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              ...
              <Link to="/login" className="ml-2 text-emerald-600 font-bold hover:text-emerald-700 transition-colors inline-flex items-center gap-1">
